...
class Y8950TimAdpcm final : public Schedulable
{
public:
	Y8950TimAdpcm(Y8950Tim& y8950, const DeviceConfig& config,
...
SERIALIZE_CLASS_VERSION(Y8950TimAdpcm, 2);
